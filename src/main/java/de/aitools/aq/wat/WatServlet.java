...
import de.aitools.aq.wat.pages.AdminAgreementStatisticsPanel;
import de.aitools.aq.wat.pages.AdminAnnotationDetailedProgressPanel;
...
public class WatServlet extends HttpServlet {
	...
	private final Panel adminAgreementStatisticsPanel;
	...
	private void serveAdmin(final HttpServletRequest request, final PrintWriter output) throws IOException
	{
		...
		else
		{
			...
			this.adminControlsPage.print(output, password, adminAction, adminActionSuccess, panels);
		}
	}
