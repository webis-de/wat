...
public class Task implements Comparable<Task>, Iterable<Component> {
	...
	public Task(
			...
			final File tasksStatesDirectory) throws IOException
	{
		if (name == null)
		{
		...
		if (!this.taskStatesDirectory.isDirectory())
		{
			...
			{
				throw new IOException("Could not create task states directory: " + this.taskStatesDirectory);
			}
		}
	}
	...
	public TaskState loadState(final String annotatorName) throws NullPointerException, IOException {
