...
{
	public AdminPage(final String projectName) throws NullPointerException
	{
		super(projectName);
	}
	...
	public void print(
			...
			final boolean adminActionSuccess,
	...
	private void printHiddenElements(final PrintWriter output, final String password)
	{
		if (password != null)
		{
			output.append("<input id=\"task-internal-field-password\" type=\"hidden\" name=\"")
				.append(WatServlet.REQUEST_PARAMETER_PASSWORD)
				.append("\" value=\"")
				.append(password)
				.append("\" />");
	...
	private void printActionSuccessBox(final PrintWriter output, final String adminAction)
	{
	...
	private void printActionFailedBox(final PrintWriter output, final String adminAction)
	{
	...
	private void printTopNavbar(final PrintWriter output, final boolean loggedIn)
	{
	...
	protected void printPanels(final PrintWriter output, final List<Panel> panels)
	{
		if (panels != null)
		{
	...
	private void printBottomNavbar(final PrintWriter output, final boolean loggedIn)
	{
		if (loggedIn)
		{
			output.append("<nav class=\"navbar navbar-default\">\n");
	...
	private void printNavbarButtons(final PrintWriter output, final boolean logout)
	{
